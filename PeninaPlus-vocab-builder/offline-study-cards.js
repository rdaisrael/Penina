(function () {
    ...
    function mountGames(groups, mountAsteroids, createAsteroids) {
        ...
        async function prepare(value) {
            ...
            byId('lobbyHelp').textContent=value==='cards'?'There are 2 rounds. Click on a term, then click on its definition. Match every term in each round.':value==='asteroids'?'There are 3 rounds: asteroids, pursuing Martians, then enemy ships.':'';
