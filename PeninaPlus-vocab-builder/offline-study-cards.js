...
<body><div class="app">
<header><div><h1>${safeTitle}</h1></div><div class="badge"><span id="count">${cards.length}</span><span>cards</span></div></header>
...
<p class="section-title" style="margin-top:16px">Paper Notecards</p><button id="paperCards" style="width:100%">Print Paper Notecards</button>
...
<dialog id="printOptionsDialog" class="print-options-dialog"><form class="print-options-form"><h2>Print Paper Notecards</h2><p class="print-options-intro">Choose what will appear on the printed cards. These choices are independent of the study-card display.</p><fieldset class="print-option-group"><legend>Cards per sheet</legend><label class="print-option-choice"><input type="radio" name="cardsPerSheet" value="6">6 per sheet</label><label class="print-option-choice"><input type="radio" name="cardsPerSheet" value="8" checked>8 per sheet</label></fieldset><fieldset class="print-option-group"><legend>Translation</legend><label class="print-option-choice"><input type="radio" name="printTranslation" value="hebrew">Hebrew</label><label class="print-option-choice"><input type="radio" name="printTranslation" value="english">English</label><label class="print-option-choice"><input type="radio" name="printTranslation" value="both" checked>Hebrew and English</label></fieldset><fieldset class="print-option-group"><legend>Context</legend><label class="print-option-choice"><input type="checkbox" id="printOriginalQuote" checked>Original quote</label><label class="print-option-choice"><input type="checkbox" id="printHebrewContext" checked>Hebrew translation</label><label class="print-option-choice"><input type="checkbox" id="printEnglishContext" checked>English translation</label></fieldset><div class="print-dialog-actions"><button id="closePrintOptions" type="button">Cancel</button><button id="confirmPrintOptions" class="primary" type="button">Preview Notecards</button></div></form></dialog>
...
<\/script></body></html>`;
    ...
    const api = { download, makeApp, toCards };
