...
module.exports = async function (req, res) {
    ...
    try {
        ...
        if (req.method === 'POST') {
            ...
            // Three rounds of five answers worth at most 300 each; three mistakes cost at most 300.
            if (typeof initials !== 'string' || !/^[A-Z]{1,3}$/.test(initials) || !Number.isInteger(score) || score < -300 || score > 4500 || score % 50 || typeof runId !== 'string' || !/^[a-zA-Z0-9-]{10,80}$/.test(runId)) {
