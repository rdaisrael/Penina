...
test('Board rejects names, invalid scores, incomplete runs, missing classes and unsupported methods',async()=>{
 ...
 for(const edit of [{initials:'David'},{initials:'<x>'},{score:-5},{score:8045},{score:NaN},{score:501},{rounds:2},{runId:'../x'}])assert.equal((await request('POST','sixth',{...valid,...edit})).code,400);
